...
namespace VWolf {
    OpenGLTexture2D::OpenGLTexture2D(uint32_t width, uint32_t height): Texture2D(width, height) {
        ...
        // TODO: Externalize
        glSamplerParameteri(m_sampleID, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
        glSamplerParameteri(m_sampleID, GL_TEXTURE_MAG_FILTER, GL_NEAREST);

        glSamplerParameteri(m_sampleID, GL_TEXTURE_WRAP_S, GL_REPEAT);
        glSamplerParameteri(m_sampleID, GL_TEXTURE_WRAP_T, GL_REPEAT);
        //
    }
