...
// WinAdapter.h (via dxcapi.h) already defines the Windows base types and COM
// macros. basetsd.h uses conflicting typedefs (e.g. ULONG/LONG/BOOL/HRESULT),
// so including both breaks non-Windows builds that use DXC + d3d12shader.h.
#ifndef LLVM_SUPPORT_WIN_ADAPTER_H
#include "basetsd.h"
#else
// MIDL-generated d3dcommon.h uses `typedef interface IFoo IFoo;` which needs
// `interface` as a macro; basetsd.h normally provides this.
#ifndef interface
